...
export const integrations = pgTable(
  'integrations',
  {
    ...
    credentialExpiration: timestamp('credential_expiration', { withTimezone: true }),
...
export const integrationLinks = pgTable(
  'integration_links',
  {
    ...
    name: text('name'),
    status: text('status', { enum: ['active', 'error', 'disabled'] }).default('active'),
...
// definitionId stored as plain text — FK enforced at app level to avoid cross-schema circular import
